...
Features:
- incremental writes to CSV
- resume from existing output
- graceful handling of HTTP 429 with backoff
- stop cleanly instead of crashing when quota/rate limits are hit
"""
    ...
    try:
        for idx, row in enumerate(pending_rows, start=1):
            ...
            try:
                ...
                # skip current row for now; user can resume later from same output
                continue
